# heat_template: static_route_vpn
This is heat_template of "static_route_vpn" which is provided by gohan via etcd

### (1) Stored data in etcd
These are stored data for "heat_templates" in etcd.
```
/config/v2.0/heat_templates/static_route_vpn
{
    "body": {
        "handler": "heat_worker", 
        "watch": [], 
