# heat_template: vpn_gateway
This is heat_template of "vpn_gateway" which is provided by gohan via etcd
...
/config/v2.0/heat_templates/vpn_gateway
{
    "body": {
        ...
        "parameter_mappings": {
            ...
            "primary_device_physical_uplink_interface": "Fvpn_service+vpn_service_id:ha_interface+uplink_interface_id:er_physical_interface+primary_interface_id:name", 
            ...
            "secondary_device_physical_uplink_interface": "Fvpn_service+vpn_service_id:ha_interface+uplink_interface_id:er_physical_interface+secondary_interface_id:name", 
