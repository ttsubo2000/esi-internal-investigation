...
```
{
    ...
    "version": 1, 
    "link": "http://collector-agents-se.monitoringrefactordocker_default:7070/targets/ca354a39-f48c-4698-9cdd-9e106e2a5bf4", 
    "syncer_properties": {
        "tsdb": {
            "traffic.in": {
                "metric": "traffic.bytes", 
    ...
    "tenant_id": "06d6b792b31c40daa546fb0f4e35980d", 
    "type": "igs_counter", 
    "id": "ca354a39-f48c-4698-9cdd-9e106e2a5bf4", 
    "resource_type": "internet_gateways"
}
```
...
```
GET http://collector-agents-se.monitoringrefactordocker_default:7070/targets/ca354a39-f48c-4698-9cdd-9e106e2a5bf4
```
