...
```
/config/v2.0/ese_physical_ports/eec156b0-7317-48dd-b76c-019c0758e99d
{
    "body": {
...
```
/jobs/all/create:heat_worker:ese_physical_port:eec156b0-7317-48dd-b76c-019c0758e99d:1:v4szq
[
    "heat_worker", 
    {
        "is_first": true, 
        ...
        "handler": "heat_worker", 
        "job_name": "ese_physical_port:eec156b0-7317-48dd-b76c-019c0758e99d:1", 
        "dependency": [], 
        "version": 1, 
        "params": [
            {
        ...
        "is_last": false, 
        "on_failure": "fail", 
        "id": "create:heat_worker:ese_physical_port:eec156b0-7317-48dd-b76c-019c0758e99d:1:v4szq", 
        "resource_input": {
            "status": "PENDING_CREATE", 
            "connected_port_owner": "mx_downlink", 
            "tags": {}, 
...
```
/jobs/all/create:monitoring_worker:ese_physical_port:eec156b0-7317-48dd-b76c-019c0758e99d:1:0d9b6
[
    "monitoring_worker", 
    {
        "is_first": false, 
        ...
        "job_name": "ese_physical_port:eec156b0-7317-48dd-b76c-019c0758e99d:1", 
        "dependency": [
            "create:heat_worker:ese_physical_port:eec156b0-7317-48dd-b76c-019c0758e99d:1:v4szq"
        ], 
        "version": 1, 
        "params": [
            {
        ...
        "is_last": true, 
        "on_failure": "fail", 
        "id": "create:monitoring_worker:ese_physical_port:eec156b0-7317-48dd-b76c-019c0758e99d:1:0d9b6", 
        "resource_input": {
            "status": "PENDING_CREATE", 
            "connected_port_owner": "mx_downlink", 
            "tags": {}, 
...
```
/esi-worker/heat_stacks/v2.0/ese_physical_ports/eec156b0-7317-48dd-b76c-019c0758e99d
{
    "stack_id": "ese_physical_port_eec156b0-7317-48dd-b76c-019c0758e99d", 
    "tenant_id": "0b576f6f4cbf414f829cd12f008bf08f", 
    ...
    "id": "ese_physical_port:eec156b0-7317-48dd-b76c-019c0758e99d"
}
```
...
```
/esi-worker/job_state/v2.0/ese_physical_ports/eec156b0-7317-48dd-b76c-019c0758e99d
{
    "heat_outputs": [
        {
            "output_value": "dddddddd-dddd-dddd-dddd-dddddddddddd", 
...
```
/state/v2.0/ese_physical_ports/eec156b0-7317-48dd-b76c-019c0758e99d
{
    "state": {
...
```
/monitoring/v2.0/ese_physical_ports/eec156b0-7317-48dd-b76c-019c0758e99d
{
    "version": 1, 
    "port": "UP"
}
