...
```
$ heat stack-show er_physical_interface_c2576120-00b0-461e-a2ae-f7bbff9465d0
+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Property              | Value                                                                                                                                                                                               |
+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| capabilities          | []                                                                                                                                                                                                  |
...
```
$ heat template-show er_physical_interface_c2576120-00b0-461e-a2ae-f7bbff9465d0
description: 'Physical port template
