...
```
/config/v2.0/ese_devices/5314fffc-6c86-4410-a64b-5386286ac629
{
    "body": {
...
```
/jobs/all/create:heat_worker:ese_device:5314fffc-6c86-4410-a64b-5386286ac629:1:g9l4c
[
    "heat_worker", 
    {
        "is_first": true, 
        ...
        "handler": "heat_worker", 
        "job_name": "ese_device:5314fffc-6c86-4410-a64b-5386286ac629:1", 
        "dependency": [], 
        "version": 1, 
        "params": [
            {
        ...
        "is_last": false, 
        "on_failure": "fail", 
        "id": "create:heat_worker:ese_device:5314fffc-6c86-4410-a64b-5386286ac629:1:g9l4c", 
        "resource_input": {
            "status": "PENDING_CREATE", 
            "username": "esi", 
            "description": "", 
...
```
/jobs/all/create:monitoring_worker:ese_device:5314fffc-6c86-4410-a64b-5386286ac629:1:x2624
[
    "monitoring_worker", 
    {
        "is_first": false, 
        ...
        "job_name": "ese_device:5314fffc-6c86-4410-a64b-5386286ac629:1", 
        "dependency": [
            "create:heat_worker:ese_device:5314fffc-6c86-4410-a64b-5386286ac629:1:g9l4c"
        ], 
        "version": 1, 
        "params": [
            {
        ...
        "is_last": true, 
        "on_failure": "fail", 
        "id": "create:monitoring_worker:ese_device:5314fffc-6c86-4410-a64b-5386286ac629:1:x2624", 
        "resource_input": {
            "status": "PENDING_CREATE", 
            "username": "esi", 
            "description": "", 
...
```
/esi-worker/heat_stacks/v2.0/ese_devices/5314fffc-6c86-4410-a64b-5386286ac629
{
    "stack_id": "ese_device_5314fffc-6c86-4410-a64b-5386286ac629", 
    "tenant_id": "0b576f6f4cbf414f829cd12f008bf08f", 
    ...
    "id": "ese_device:5314fffc-6c86-4410-a64b-5386286ac629"
}
```
...
```
/esi-worker/job_state/v2.0/ese_devices/5314fffc-6c86-4410-a64b-5386286ac629
{
    "heat_outputs": [
        {
            "output_value": [
...
```
/state/v2.0/ese_devices/5314fffc-6c86-4410-a64b-5386286ac629
{
    "state": {
...
```
/monitoring/v2.0/ese_devices/5314fffc-6c86-4410-a64b-5386286ac629
{
    "switch": "UP", 
    "version": 1
}
