...
```
/config/v2.0/ese_physical_ports/97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c
{
    "body": {
...
```
/jobs/all/create:heat_worker:ese_physical_port:97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c:1:k4lop
[
    "heat_worker", 
    {
        "is_first": true, 
        ...
        "handler": "heat_worker", 
        "job_name": "ese_physical_port:97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c:1", 
        "dependency": [], 
        "version": 1, 
        "params": [
            {
        ...
        "is_last": false, 
        "on_failure": "fail", 
        "id": "create:heat_worker:ese_physical_port:97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c:1:k4lop", 
        "resource_input": {
            "status": "PENDING_CREATE", 
            "connected_port_owner": "mx_downlink", 
            "tags": {}, 
...
```
/jobs/all/create:monitoring_worker:ese_physical_port:97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c:1:ff54e
[
    "monitoring_worker", 
    {
        "is_first": false, 
        ...
        "job_name": "ese_physical_port:97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c:1", 
        "dependency": [
            "create:heat_worker:ese_physical_port:97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c:1:k4lop"
        ], 
        "version": 1, 
        "params": [
            {
        ...
        "is_last": true, 
        "on_failure": "fail", 
        "id": "create:monitoring_worker:ese_physical_port:97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c:1:ff54e", 
        "resource_input": {
            "status": "PENDING_CREATE", 
            "connected_port_owner": "mx_downlink", 
            "tags": {}, 
...
```
/esi-worker/heat_stacks/v2.0/ese_physical_ports/97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c
{
    "stack_id": "ese_physical_port_97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c", 
    "tenant_id": "0b576f6f4cbf414f829cd12f008bf08f", 
    ...
    "id": "ese_physical_port:97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c"
}
```
...
```
/esi-worker/job_state/v2.0/ese_physical_ports/97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c
{
    "heat_outputs": [
        {
            "output_value": "dddddddd-dddd-dddd-dddd-dddddddddddd", 
...
```
/state/v2.0/ese_physical_ports/97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c
{
    "state": {
...
```
/monitoring/v2.0/ese_physical_ports/97fcdf3a-81a4-41a5-8ae6-52c431fc5a5c
{
    "version": 1, 
    "port": "UP"
}
