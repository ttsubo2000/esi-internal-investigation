...
```
$ heat stack-show gw_interface_b9618566-14ea-4505-8eae-8fdb4b6a0ec1
+-----------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Property              | Value                                                                                                                                                         |
+-----------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------+
| capabilities          | []                                                                                                                                                            |
...
```
$ heat template-show gw_interface_b9618566-14ea-4505-8eae-8fdb4b6a0ec1
description: 'Inet Address
...
resources:
  ...
  netconf_configure_secondary:
    ...
    type: OS::Contrail::NetconfNamedConfig
```
