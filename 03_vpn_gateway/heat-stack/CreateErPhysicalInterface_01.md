...
```
$ heat stack-show er_physical_interface_f3ecf585-5c3b-445a-97a7-d8e124c99e16
+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Property              | Value                                                                                                                                                                                               |
+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| capabilities          | []                                                                                                                                                                                                  |
...
```
$ heat template-show er_physical_interface_f3ecf585-5c3b-445a-97a7-d8e124c99e16
description: 'Physical port template
