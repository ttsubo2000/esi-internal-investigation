# heat_template: aws_gateway
This is heat_template of "aws_gateway" which is provided by gohan via etcd
...
```
/config/v2.0/heat_templates/aws_gateway
{
    "body": {
        "handler": "heat_worker", 
        "watch": [], 
        ...
        "parameter_mappings": {
            ...
            "primary_device_physical_uplink_interface": "Faws_service+aws_service_id:ha_interface+uplink_interface_id:er_physical_interface+primary_interface_id:name", 
            ...
            "secondary_device_physical_uplink_interface": "Faws_service+aws_service_id:ha_interface+uplink_interface_id:er_physical_interface+secondary_interface_id:name", 
