# heat_template: aws_interface
This is heat_template of "aws_interface" which is provided by gohan via etcd
...
```
/config/v2.0/heat_templates/aws_interface
{
    "body": {
        "handler": "heat_worker", 
        "watch": [], 
        ...
        "parameter_mappings": {
            ...
            "secondary_device_physical_interface": "Faws_gateway+aws_gw_id:aws_service+aws_service_id:ha_interface+uplink_interface_id:er_physical_interface+secondary_interface_id:name", 
            ...
            "primary_device_physical_interface": "Faws_gateway+aws_gw_id:aws_service+aws_service_id:ha_interface+uplink_interface_id:er_physical_interface+primary_interface_id:name", 
