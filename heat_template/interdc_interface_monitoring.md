# monitoring_template: interdc_interface_monitoring
This is monitoring_template of "interdc_interface_monitoring" which is provided by gohan via etcd
...
```
/config/v2.0/heat_templates/interdc_interface_monitoring
{
    "body": {
        "handler": "monitoring_worker", 
        "watch": [], 
        "id": "interdc_interface_monitoring", 
