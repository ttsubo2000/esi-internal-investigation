...
```
/jobs/all/modify:heat_worker:vpn_gateway:b1da850c-3344-4de2-aa18-d96a30b54f69:2:5iv3e
[
    "heat_worker", 
    {
        "is_first": true, 
        ...
        "handler": "heat_worker", 
        "job_name": "vpn_gateway:b1da850c-3344-4de2-aa18-d96a30b54f69:2", 
        "dependency": [
            "create:heat_worker:vpn_interface:07d4f1fc-5142-4fae-b115-627fc009e222:1:1r2cs"
        ], 
        "version": 2, 
        "params": [
            {
        ...
        "is_last": true, 
        "on_failure": "fail", 
        "id": "modify:heat_worker:vpn_gateway:b1da850c-3344-4de2-aa18-d96a30b54f69:2:5iv3e", 
        "resource_input": {
