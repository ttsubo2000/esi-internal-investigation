...
```
/config/v2.0/ese_devices/a1f745c1-e6b9-45ef-94db-f33b37709fb0
{
    "body": {
...
```
/jobs/all/create:heat_worker:ese_device:a1f745c1-e6b9-45ef-94db-f33b37709fb0:1:gyov9
[
    "heat_worker", 
    {
        "is_first": true, 
        ...
        "handler": "heat_worker", 
        "job_name": "ese_device:a1f745c1-e6b9-45ef-94db-f33b37709fb0:1", 
        "dependency": [], 
        "version": 1, 
        "params": [
            {
        ...
        "is_last": false, 
        "on_failure": "fail", 
        "id": "create:heat_worker:ese_device:a1f745c1-e6b9-45ef-94db-f33b37709fb0:1:gyov9", 
        "resource_input": {
            "status": "PENDING_CREATE", 
            "username": "esi", 
            "description": "", 
...
```
/jobs/all/create:monitoring_worker:ese_device:a1f745c1-e6b9-45ef-94db-f33b37709fb0:1:z0i89
[
    "monitoring_worker", 
    {
        "is_first": false, 
        ...
        "job_name": "ese_device:a1f745c1-e6b9-45ef-94db-f33b37709fb0:1", 
        "dependency": [
            "create:heat_worker:ese_device:a1f745c1-e6b9-45ef-94db-f33b37709fb0:1:gyov9"
        ], 
        "version": 1, 
        "params": [
            {
        ...
        "is_last": true, 
        "on_failure": "fail", 
        "id": "create:monitoring_worker:ese_device:a1f745c1-e6b9-45ef-94db-f33b37709fb0:1:z0i89", 
        "resource_input": {
            "status": "PENDING_CREATE", 
            "username": "esi", 
            "description": "", 
...
```
/esi-worker/heat_stacks/v2.0/ese_devices/a1f745c1-e6b9-45ef-94db-f33b37709fb0
{
    "stack_id": "ese_device_a1f745c1-e6b9-45ef-94db-f33b37709fb0", 
    "tenant_id": "0b576f6f4cbf414f829cd12f008bf08f", 
    ...
    "id": "ese_device:a1f745c1-e6b9-45ef-94db-f33b37709fb0"
}
```
...
```
/esi-worker/job_state/v2.0/ese_devices/a1f745c1-e6b9-45ef-94db-f33b37709fb0
{
    "heat_outputs": [
        {
            "output_value": [
...
```
/state/v2.0/ese_devices/a1f745c1-e6b9-45ef-94db-f33b37709fb0
{
    "state": {
...
```
/monitoring/v2.0/ese_devices/a1f745c1-e6b9-45ef-94db-f33b37709fb0
{
    "switch": "UP", 
    "version": 1
}
