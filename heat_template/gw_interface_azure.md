# heat_template: gw_interface_azure
This is heat_template of "gw_interface_azure" which is provided by gohan via etcd

### (1) Stored data in etcd
These are stored data for "heat_templates" in etcd.
```
/config/v2.0/heat_templates/gw_interface_azure
{
    "body": {
        "handler": "heat_worker", 
        "watch": [], 
